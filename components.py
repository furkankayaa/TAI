...
class List_item(QWidget):
    def __init__(self):
        ...
        self.stock_quantity.setMinimumWidth(45)
        ...
        self.slash = QLabel(self.horizontalLayoutWidget)
        self.slash.setMaximumWidth(10)
        self.slash.setText('/')
        ...
        self.result_sell_quantity.setMinimumWidth(100)
        ...
        #ADD Widgets to horizontalLayout
